const Footer = () => {
  return (
    <footer className=" relative flex bg-gray-900 pl-[43px] pt-[43px] shadow-xs md:h-auto md:pl-5 md:pt-5">
      <div className="relative h-[304px] w-[96%]">
        <div className="absolute left-[0.00px] top-[0.00px] m-auto flex w-[45%] items-start justify-between gap-5 md:relative md:flex-col">
          <div className="flex flex-col gap-3.5 md:p-5 ">
            ...
            <ul className="flex flex-col">
              <li>
                <a href="#">
                  <p className="!text-gray-400">+03135939584</p>
                </a>
              </li>
              <li>
                <a href="#" className="mt-4">
                  <p className="!text-blue_gray-500">email@email.com</p>
                </a>
              </li>
              <li>
                <a href="#" className="mt-3.5">
                  <p className="!text-gray-400">
                    29 city 12 constantine algeria
                  </p>
                </a>
              </li>
              <li>
                <a href="#" className="mt-[41px] text-white">
                  <h4 className="!text-white font-bold">Social media links</h4>
                </a>
              </li>
              <li>
          ...
          <ul className="flex flex-col items-start gap-4 md:p-5">
            <li>
              <a href="#">
                <h4 className="!text-white font-bold ">Navigation links</h4>
              </a>
            </li>
            <li>
              <a href="#">
            ...
            <li>
              <a href="#">
                <p className="!text-gray-400">Shipping information</p>
              </a>
            </li>
            <li>
              <a href="#">
                <p className="!text-gray-400">Terms and Services</p>
              </a>
            </li>
          </ul>
        </div>
        <div className="absolute right-[16%] top-[0.00px] m-auto flex flex-col items-start gap-[15px]">
          ...
          <p className="!text-gray-400">
            sohaib.bouzitouna@univ-constantine2.dz
          </p>
